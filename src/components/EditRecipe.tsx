...
const EditRecipe: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      recipe.title &&
      (ingredients.length || subRecipes.length) &&
      recipe.instructions
    ) {
      ...
      alert(
        "Please fill in all required fields: title, at least one ingredient or subrecipe, and instructions.",
      );
    }
  };
